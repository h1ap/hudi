 ...
 *
 * <p>This implementation extracts the partition value of yyyy-mm-dd from the path of type yyyy-mm-dd.
 */
public class HivePartitionValueExtractor implements PartitionValueExtractor {

  private static final long serialVersionUID = 1L;
  private transient DateTimeFormatter dtfOut;

  public HivePartitionValueExtractor() {
  ...
  public List<String> extractPartitionValuesInPath(String partitionPath) {
    // partition path is expected to be in this format partition_value.
    String[] splits = partitionPath.split("-");
    if (splits.length != 3) {
      throw new IllegalArgumentException("Partition path " + partitionPath + " is not in the form partition_value.");
    }
